...
// app/api/provider/forgot-password/route.js
import { NextResponse } from 'next/server'
import { execute } from '@/lib/db'
import { randomBytes } from 'crypto'
import { sendEmail } from '@/lib/email'
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#475569;line-height:1.7;">
                We received a request to reset the password for your WorkOnTap provider account. 
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
                <tr>
                  <td align="center">
                    <div style="display:inline-block;padding:16px 40px;background:#f1f5f9;color:#0f766e;border-radius:12px;font-size:32px;font-weight:800;letter-spacing:8px;border:2px dashed #0f766e;font-family:monospace;">
                      ${otp}
                    </div>
                  </td>
                </tr>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0;font-size:13px;color:#94a3b8;">
                Or copy this link: <span style="word-break:break-all;color:#0f766e;">${resetUrl}</span>
              </p>
            </td>
          </tr>

...
export default function EditSeoSetting({ params }) {
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input type="text" required value={setting.page_name || ''}
                  onChange={(e) => setSetting({ ...setting, page_name: e.target.value })}
                  placeholder="e.g. home, about-us, or global"
                  className={inputClasses}
                  disabled={setting.page_name === 'global'}
                />
                <p className={`text-xs mt-1 ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>
                  {setting.page_name === 'global' ? 'Global setting name cannot be changed.' : 'Use "global" to apply header/footer scripts globally across the site.'}
                </p>
              </div>

              <div>
                <label className={labelClasses}>Meta Title</label>
                <input type="text" value={setting.meta_title || ''}
                  onChange={(e) => setSetting({ ...setting, meta_title: e.target.value })}
                  className={inputClasses}
                />
              </div>
              ...
              <div>
                ...
                <input type="url" value={setting.canonical_url || ''}
                  onChange={(e) => setSetting({ ...setting, canonical_url: e.target.value })}
                  className={inputClasses}
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <input type="text" value={setting.keywords || ''}
                  onChange={(e) => setSetting({ ...setting, keywords: e.target.value })}
              ...
              <div className="md:col-span-2">
                ...
                <textarea rows="3" value={setting.meta_description || ''}
                  onChange={(e) => setSetting({ ...setting, meta_description: e.target.value })}
                  className={inputClasses}
                />
              </div>
              ...
              <div>
                ...
                <input type="text" value={setting.og_title || ''}
                  onChange={(e) => setSetting({ ...setting, og_title: e.target.value })}
                  className={inputClasses}
                />
              </div>
              ...
              <div>
                ...
                <input type="url" value={setting.og_image || ''}
                  onChange={(e) => setSetting({ ...setting, og_image: e.target.value })}
                  className={inputClasses}
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea rows="2" value={setting.og_description || ''}
                  onChange={(e) => setSetting({ ...setting, og_description: e.target.value })}
                  className={inputClasses}
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea rows="4" value={setting.header_scripts || ''}
                  onChange={(e) => setSetting({ ...setting, header_scripts: e.target.value })}
              ...
              <div className="md:col-span-2">
                ...
                <textarea rows="4" value={setting.footer_scripts || ''}
                  onChange={(e) => setSetting({ ...setting, footer_scripts: e.target.value })}

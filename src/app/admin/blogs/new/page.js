...
export default function NewBlog() {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        setNewBlog({ ...newBlog, image_url: data.url });
      } else {
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input type="text" required value={newBlog.title}
                  onChange={(e) => {
                    const val = e.target.value;
                    const slug = val.toLowerCase().trim().replace(/[^\w\s-]/g, '').replace(/\s+/g, '-').replace(/-+/g, '-');
                    setNewBlog({ ...newBlog, title: val, slug: newBlog.id ? newBlog.slug : slug })
                  }}
              ...
              <div>
                ...
                <input type="text" required value={newBlog.slug}
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex items-center gap-4">
                  {newBlog.image_url && (
                    <img src={newBlog.image_url} alt="Preview" className="h-16 w-16 object-cover rounded-lg border border-gray-200" />
                  )}
              ...
              <div className="md:col-span-2">
                ...
                <div className={`mt-1 ${isDarkMode ? 'dark-mode-ckeditor' : ''}`}>
                  <RichTextEditor 
                    ...
                    onChange={(data) => setNewBlog({ ...newBlog, content: data })}
              ...
              <div>
                ...
                <input type="text" value={newBlog.meta_title}
              ...
              <div>
                ...
                <input type="text" value={newBlog.keywords}
              ...
              <div className="md:col-span-2">
                ...
                <textarea rows="3" value={newBlog.meta_description}
              ...
              <div className="md:col-span-2 flex items-center mt-4">
                <input type="checkbox" id="is_published" checked={newBlog.is_published}

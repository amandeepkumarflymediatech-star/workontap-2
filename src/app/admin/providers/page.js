      ...
      <div className="px-3 sm:px-4 md:px-6 py-4 sm:py-6 max-w-7xl mx-auto">
        ...
        <div className="mb-4 sm:mb-6 md:mb-8">
          ...
          <p className={`mt-0.5 sm:mt-1 text-sm sm:text-base ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
            View and review provider applications
          </p>
        </div>

        {/* Stats Cards - Responsive Grid */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-8">
          ...
          <div className={`rounded-xl shadow-sm border p-3 sm:p-4 md:p-6 ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'}`}>
            <p className={`text-xs sm:text-sm mb-0.5 sm:mb-1 ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Inactive</p>
            <p className="text-xl sm:text-2xl md:text-3xl font-bold text-yellow-600">{stats.inactive || 0}</p>
          </div>
          <div className={`rounded-xl shadow-sm border p-3 sm:p-4 md:p-6 ${isDarkMode ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'}`}>
                ...
                <table className="w-full">
                  <thead className={`border-b ${isDarkMode ? 'bg-slate-900 border-slate-700' : 'bg-gray-50 border-gray-200'}`}>
                    <tr>
                      ...
                      <th className={`px-4 xl:px-6 py-3 xl:py-4 text-left text-xs font-semibold uppercase tracking-wider ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>Action</th>
                    </tr>
                  </thead>
